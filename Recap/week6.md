...
```
  ...
  - `glimpse()` is used to show the class of **all** variables in a data frame. `class()` is used to show the class of **one** variable.  
  - Some variables need to be parsed into correct classes.